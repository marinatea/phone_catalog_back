...
const accessories_route_1 = __importDefault(require("./routes/accessories.router"));
const body_parser_1 = __importDefault(require("body-parser"));
const cors_1 = __importDefault(require("cors"));
const phones_route_1 = __importDefault(require("./routes/phones.router"));
const products_router_1 = __importDefault(require("./routes/products.router"));
const models_1 = require("./models");
const tablets_route_1 = __importDefault(require("./routes/tablets.router"));
